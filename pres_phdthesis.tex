...
\begin{frame}{1. Universalisation - Discussion and Results}
	...
	Independence is only satisfied between actions universalised \textquote{equivalently}.
...
\begin{frame}{2. Meritocracy as an End and as a Means}
	...
	A preference \( \succsim_i \) is more \textquote{meritorious} than \( \succsim_i^{\prime} \) if
